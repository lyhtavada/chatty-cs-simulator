...
- The merchant cannot self-fix this — the sync has to be reset and restarted from our side. Escalate to the team with the store URL, the sync timestamp, and a screenshot of the stuck sync status, rather than telling the merchant to retry.
...
A: Only published, in-stock products are synced to the AI. Products sync daily at 00:00 UTC.

**Common causes:**
- Products are in draft status or out of stock.
- The merchant has hit their plan's product limit (Free: 200, Basic: 500, Pro: 8,000, Plus: Unlimited).
...
3. Advise the merchant not to sync repeatedly — either sync manually once or rely on the daily auto-sync at 00:00 UTC.
...
4. For small increases (100-200 products, 10-20 URLs/Files): CS can proactively extend the limit for the merchant on our side without requiring an upgrade.
